...
@Metadata(d1 = {"\u0000R\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\u0010\u000e\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0006\n\u0002\u0018\u0002\n\u0002\b\u0004\u0018\u00002\u00020\u0001B\u0007Â¢\u0006\u0004\b\u0002\u0010\u0003J\b\u0010\u0011\u001a\u00020\u0012H\u0016J\b\u0010\u0013\u001a\u00020\u0014H\u0014J\u0010\u0010\u0015\u001a\u00020\u00122\u0006\u0010\u0016\u001a\u00020\u0017H\u0014J\b\u0010\u0018\u001a\u00020\u0012H\u0014J\u0010\u0010\u0019\u001a\u00020\u00122\u0006\u0010\u0016\u001a\u00020\u0017H\u0002J\u0010\u0010\u001a\u001a\u00020\u00122\u0006\u0010\u0016\u001a\u00020\u0017H\u0014J\b\u0010\u001b\u001a\u00020\u0012H\u0016J\u0010\u0010\u001c\u001a\u00020\t2\u0006\u0010\u0016\u001a\u00020\u0017H\u0002J\u0018\u0010\u001d\u001a\u00020\u001e2\u0006\u0010\u0016\u001a\u00020\u00172\u0006\u0010\u001f\u001a\u00020\tH\u0002J\u0018\u0010 \u001a\u00020\u00122\u0006\u0010\u0016\u001a\u00020\u00172\u0006\u0010!\u001a\u00020\tH\u0002R\u0016\u0010\u0004\u001a\n \u0006*\u0004\u0018\u00010\u00050\u0005X\u0082\u0004Â¢\u0006\u0002\n\u0000R\u001a\u0010\u0007\u001a\u000e\u0012\u0004\u0012\u00020\t\u0012\u0004\u0012\u00020\n0\bX\u0082\u0004Â¢\u0006\u0002\n\u0000R\u000e\u0010\u000b\u001a\u00020\fX\u0082.Â¢\u0006\u0002\n\u0000R\u000e\u0010\r\u001a\u00020\u000eX\u0082.Â¢\u0006\u0002\n\u0000R\u000e\u0010\u000f\u001a\u00020\u0010X\u0082.Â¢\u0006\u0002\n\u0000Â¨\u0006\""}, d2 = {"Lcom/rapprinter/smartprint/printservice/ReceiptPrintService;", "Landroid/printservice/PrintService;", "<init>", "()V", "executor", "Ljava/util/concurrent/ExecutorService;", "kotlin.jvm.PlatformType", "cancellations", "Ljava/util/concurrent/ConcurrentHashMap;", "", "Ljava/util/concurrent/atomic/AtomicBoolean;", "repository", "Lcom/rapprinter/smartprint/storage/JobRepository;", "preferences", "Lcom/rapprinter/smartprint/storage/AppPreferences;", "processor", "Lcom/rapprinter/smartprint/printservice/PrintJobProcessor;", "onCreate", "", "onCreatePrinterDiscoverySession", "Landroid/printservice/PrinterDiscoverySession;", "onPrintJobQueued", "printJob", "Landroid/printservice/PrintJob;", "onConnected", "enqueue", "onRequestCancelPrintJob", "onDestroy", "ensureDurableTag", "recoveryRecord", "Lcom/rapprinter/smartprint/storage/JobRecord;", "id", "failFrameworkJob", "message", "app"}, k = 1, mv = {2, 2, 0}, xi = 48)
...
public final class ReceiptPrintService extends PrintService {
    ...
    static final Thread executor$lambda$1(Runnable runnable) {
        Thread thread = new Thread(runnable, "RapPrint-JobQueue");
        ...
        for (PrintJob printJob : activePrintJobs) {
            ...
            if (str != null) {
                ...
                if ((find != null ? find.getStatus() : null) == JobStatus.COMPLETED) {
                    ...
                    printJob.fail("Status pengiriman tidak pasti â€” periksa kertas sebelum mencetak ulang");
    ...
    */
    private final void enqueue(PrintJob printJob) {
        ...
        if (PrintJobRecoveryRules.INSTANCE.mustHoldBeforeResend(previous)) {
            ...
            JobRepository.upsert$default(jobRepository2, JobRecord.copy$default(previous, null, null, null, 0L, null, null, null, 0, 0, false, 0L, 0L, jobStatus, error, "RapPrint menahan pengiriman otomatis. Periksa kertas lalu cetak ulang manual dari Riwayat.", null, 36863, null), false, 2, null);
            failFrameworkJob(printJob, "Status sebelumnya tidak pasti â€” periksa kertas sebelum mencetak ulang");
            return;
        }
