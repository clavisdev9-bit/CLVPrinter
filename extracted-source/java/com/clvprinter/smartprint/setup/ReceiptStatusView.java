...
public final class ReceiptStatusView extends View {
    ...
    public ReceiptStatusView(Context context, AttributeSet attrs) {
        super(context, attrs);
        Intrinsics.checkNotNullParameter(context, "context");
        this.profileLabel = "384 DOT • 203 DPI";
    ...
    protected void onDraw(Canvas canvas) {
        ...
        Intrinsics.checkNotNullExpressionValue(getContext(), "getContext(...)");
        Intrinsics.checkNotNullExpressionValue(getContext(), "getContext(...)");
        drawFittedText(canvas, "STATUS / CLVPRINTER", receiptLeft + UiKitKt.dp(r1, 13), eyebrowBaseline, (receiptRight - receiptLeft) - UiKitKt.dp(r5, 26));
        ...
        Intrinsics.checkNotNullExpressionValue(getContext(), "getContext(...)");
        Intrinsics.checkNotNullExpressionValue(getContext(), "getContext(...)");
        drawFittedText(canvas, "58 MM • " + upperCase, receiptLeft + UiKitKt.dp(r3, 13), profileBaseline, (receiptRight - receiptLeft) - UiKitKt.dp(r5, 26));
